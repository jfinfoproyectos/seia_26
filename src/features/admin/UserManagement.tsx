                                                    ...
                                                    <div className="text-xs space-y-1">
                                                        ...
                                                        {user.role === "student" && (
                                                            <>
                                                                ...
                                                                <div>{user._count.evaluationSubmissions} evaluaciones</div>
                                                            </>
                                                        )}
                                                    </div>
                                                )}
                                                    ...
                                                    <CardContent className="space-y-4">
                                                        ...
                                                        {selectedUser._count && (
                                                            <div className="grid grid-cols-3 gap-2 mt-4 text-center">
                                                                ...
                                                                <div className="bg-primary/5 p-2 rounded-md">
                                                                    <div className="text-2xl font-bold">{selectedUser._count.evaluationSubmissions || 0}</div>
                                                ...
                                                <TabsContent value="submissions">
                                                    <Card>
                                                        ...
                                                        <CardContent>
                                                            ...
                                                            ) : fullUserDetails?.evaluationSubmissions?.length > 0 ? (
                                                                <Table>
                                                                    <TableHeader>
                                                                        <TableRow>
                                                                    ...
                                                                    <TableBody>
                                                                        {fullUserDetails.evaluationSubmissions.map((sub: any) => (
                                                                            <TableRow key={sub.id}>
                                                                                <TableCell className="font-medium">
                                                                                    {sub.attempt.evaluation.title}
                                                                                </TableCell>
                                                                                <TableCell>{sub.attempt.course?.title || "N/A"}</TableCell>
                                                                                <TableCell>
                                                                                    {format(new Date(sub.submittedAt || sub.createdAt), "PPP HH:mm")}
                                                                                </TableCell>
                                                                                <TableCell>
                                                                                    {sub.score !== null ? (
                                                                                        <Badge variant={sub.score >= 3 ? 'default' : 'destructive'}>
                                                                                            {sub.score.toFixed(1)}
                                                                                        </Badge>
                                                                                    ) : (
